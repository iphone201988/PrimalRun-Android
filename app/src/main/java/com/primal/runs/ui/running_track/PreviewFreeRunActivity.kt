...
import com.primal.runs.databinding.ActivityPreviewFreeRunBinding
...
@AndroidEntryPoint
class PreviewFreeRunActivity : BaseActivity<ActivityPreviewFreeRunBinding>(), HBRecorderListener {
    ...
    override fun getLayoutResource(): Int {
        return R.layout.activity_preview_free_run
    }
    ...
    private fun initView() {
        ...
        hitCount = intent.getIntExtra("lifeCount", 0)
        ...
        binding.clMain.viewTreeObserver.addOnGlobalLayoutListener(object :
            ...
            override fun onGlobalLayout() {
                ...
                val rationale =
                    "This app needs access to your storage and camera to function properly."
                val options = Permissions.Options()
                Permissions.check(
                    this@PreviewFreeRunActivity,
                    arrayOf(
    ...
    private fun initVideoPlayer() {
        ...
        /*val videoUrl =
            "https://primalrunbucket.s3.us-east-1.amazonaws.com/videos/stageVideos/1080/Stage1.mp4"*/
